function Clear-CurrentUserTemp {
    ...
    .DESCRIPTION
        Use one inclusive UTC LastWriteTime cutoff. Directory removal is opt-in and
    ...
    .PARAMETER RemoveEmptyDirectory
        ...
        pre-existing empty branches or the temporary directory itself.
    .PARAMETER PassThru
    ...
    if ([Environment]::OSVersion.Platform -ne [PlatformID]::Win32NT) {
        throw [System.PlatformNotSupportedException]::new('Clear-CurrentUserTemp requires Windows.')
    }
