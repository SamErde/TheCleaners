...
Source and package evidence was collected at commit `338b075090c6cbe869ac0150e04214030addb18e`; the ledger update itself is documentation-only and this is not a merged commit or a hosted CI run. No real Windows, IIS, or Exchange cleanup was run, and no release tag or Gallery publication was performed.
...
- [x] Meet at least 80% overall coverage and explicitly test every safety-critical branch; local PS5.1 measured 83.04% of `1,315` analyzed commands with no skipped tests at `338b075`, while hosted CI and remaining unexecuted failure branches still require evidence.
