...
Source and package evidence was collected at commit `a874a05d807c872f3537008d59df819439ec5015`; the ledger update itself is documentation-only and this is not a merged commit or a hosted CI run. No real Windows, IIS, or Exchange cleanup was run, and no release tag or Gallery publication was performed.
...
- [x] Meet at least 80% overall coverage and explicitly test every safety-critical branch; local PS5.1 measured 82.13% (`841/1024` commands) with no skipped tests at `a874a05`, while hosted CI and remaining unexecuted failure branches still require evidence.
