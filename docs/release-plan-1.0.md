...
Source and package evidence was collected at commit `0fe33d9654be368e5177cd5c0905d4a38c205568`; the ledger update itself is documentation-only and this is not a merged commit or a hosted CI run. No real Windows, IIS, or Exchange cleanup was run, and no release tag or Gallery publication was performed.
...
| PS7 current suite | Pester `5.9.1`; `172/172` passed; `0` failed, skipped, or not run; report runtime `7.6.6 Core`; no coverage instrumentation was enabled for this run; tested commit `0fe33d9654be368e5177cd5c0905d4a38c205568`. | Hosted CI still needs the configured supported 7 LTS and current-stable run URLs. |
| Windows PowerShell compatibility and coverage | Pester `5.9.1`; PS `5.1.26100.9444` Desktop; `172/172` unit tests passed; `0` failed, skipped, or not run; `81.88%` (`985/1203` commands executed/analyzed); report commit `0fe33d9654be368e5177cd5c0905d4a38c205568`. The reusable build task now preloads the CodeDOM-generated native helper before Pester creates worker runspaces, so the complete native suite ran. | Hosted PS5.1 acceptance still requires its CI run URL. |
...
- [x] Meet at least 80% overall coverage and explicitly test every safety-critical branch; local PS5.1 measured 81.88% (`985/1203` commands) with no skipped tests at `0fe33d9`, while hosted CI and remaining unexecuted failure branches still require evidence.
