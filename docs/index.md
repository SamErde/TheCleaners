...
The [prepared 0.0.15-beta release](releases/0.0.15-beta.md) passed exact merged-source artifact and delivery validation and is awaiting publication approval. Windows, IIS, Exchange, and profile lab validation is deferred future work, not underway.
